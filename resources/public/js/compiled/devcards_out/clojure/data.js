...
return cljs.core.reduce.call(null,(function (result,p__34602){
var vec__34603 = p__34602;
var k = cljs.core.nth.call(null,vec__34603,(0),null);
var v = cljs.core.nth.call(null,vec__34603,(1),null);
...
var vec__34609 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__34609,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__34609,(1),null);
var ab = cljs.core.nth.call(null,vec__34609,(2),null);
...
var args34612 = [];
var len__27992__auto___34615 = arguments.length;
var i__27993__auto___34616 = (0);
while(true){
if((i__27993__auto___34616 < len__27992__auto___34615)){
args34612.push((arguments[i__27993__auto___34616]));

var G__34617 = (i__27993__auto___34616 + (1));
i__27993__auto___34616 = G__34617;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34612.length)].join('')));
...
var m__27523__auto__ = (clojure.data.equality_partition[goog.typeOf(x__27522__auto__)]);
if(!((m__27523__auto__ == null))){
return m__27523__auto__.call(null,x);
} else {
var m__27523__auto____$1 = (clojure.data.equality_partition["_"]);
...
var x__27522__auto__ = (((a == null))?null:a);
var m__27523__auto__ = (clojure.data.diff_similar[goog.typeOf(x__27522__auto__)]);
if(!((m__27523__auto__ == null))){
return m__27523__auto__.call(null,a,b);
} else {
var m__27523__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__27523__auto____$1 == null))){
return m__27523__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__34622 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__34622) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1537985794861