...
}catch (e34072){if((e34072 instanceof Error)){
var e = e34072;
return null;
} else {
throw e34072;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__34073){
...
var opts = map__34076__$1;
var retry_count = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__27148__auto__ = (10000);
var y__27149__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__5455__auto__,map__34076,map__34076__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1538029291043