...
return (new CustomEvent(event_name,(function (){var obj34038 = {"detail":data};
return obj34038;
})()));
} else {
...
var args34043 = [];
var len__27992__auto___34049 = arguments.length;
var i__27993__auto___34050 = (0);
while(true){
if((i__27993__auto___34050 < len__27992__auto___34049)){
args34043.push((arguments[i__27993__auto___34050]));

var G__34051 = (i__27993__auto___34050 + (1));
i__27993__auto___34050 = G__34051;
continue;
} else {
}
break;
...
var f = (function (){var pred__34046 = cljs.core._EQ_;
var expr__34047 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34046.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34047))){
return ((function (pred__34046,expr__34047){
return (function (p1__34039_SHARP_){
return console.warn(p1__34039_SHARP_);
});
;})(pred__34046,expr__34047))
} else {
if(cljs.core.truth_(pred__34046.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34047))){
return ((function (pred__34046,expr__34047){
return (function (p1__34040_SHARP_){
return console.debug(p1__34040_SHARP_);
});
;})(pred__34046,expr__34047))
} else {
if(cljs.core.truth_(pred__34046.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34047))){
return ((function (pred__34046,expr__34047){
return (function (p1__34041_SHARP_){
return console.error(p1__34041_SHARP_);
});
;})(pred__34046,expr__34047))
} else {
return ((function (pred__34046,expr__34047){
return (function (p1__34042_SHARP_){
return console.log(p1__34042_SHARP_);
});
;})(pred__34046,expr__34047))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34053){
...
var opts = map__34056__$1;
var eval_fn = cljs.core.get.call(null,map__34056__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34058_SHARP_);
});})(new_def))
);
...
return (function (p__34059){
var vec__34060 = p__34059;
var ky = cljs.core.nth.call(null,vec__34060,(0),null);
var v = cljs.core.nth.call(null,vec__34060,(1),null);
...
var args34063 = [];
var len__27992__auto___34066 = arguments.length;
var i__27993__auto___34067 = (0);
while(true){
if((i__27993__auto___34067 < len__27992__auto___34066)){
args34063.push((arguments[i__27993__auto___34067]));

var G__34068 = (i__27993__auto___34067 + (1));
i__27993__auto___34067 = G__34068;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34063.length)].join('')));
...
//# sourceMappingURL=utils.js.map?rel=1537985794096