...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27461__auto__,writer__27462__auto__,opt__27463__auto__){
return cljs.core._write.call(null,writer__27462__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__41270 = o;
(G__41270[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__41278 = jsprops;
(G__41278["defaultValue"] = value);

(G__41278["onChange"] = ((function (G__41278,v,value,on_change){
return (function (p1__41276_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__41276_SHARP_);
});})(G__41278,v,value,on_change))
);
...
var vec__41285 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__41285,(0),null);
var id = cljs.core.nth.call(null,vec__41285,(1),null);
var class$ = cljs.core.nth.call(null,vec__41285,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___41290 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___41290 == null)){
} else {
var key_41291 = temp__5461__auto___41290;
(jsprops["key"] = key_41291);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__41293 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__41293["name"] = c);
...
var len__27992__auto___41299 = arguments.length;
var i__27993__auto___41300 = (0);
while(true){
if((i__27993__auto___41300 < len__27992__auto___41299)){
args__27999__auto__.push((arguments[i__27993__auto___41300]));

var G__41301 = (i__27993__auto___41300 + (1));
i__27993__auto___41300 = G__41301;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28000__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq41297){
var G__41298 = cljs.core.first.call(null,seq41297);
var seq41297__$1 = cljs.core.next.call(null,seq41297);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__41298,seq41297__$1);
});
...
break;
default:
var G__41305 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__41305;
continue;
...
var n__27822__auto___41308 = a.length;
var i_41309 = (0);
while(true){
if((i_41309 < n__27822__auto___41308)){
(a[i_41309] = reagent.impl.template.as_element.call(null,(a[i_41309])));

var G__41310 = (i_41309 + (1));
i_41309 = G__41310;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__27822__auto___41311 = a.length;
var i_41312 = (0);
while(true){
if((i_41312 < n__27822__auto___41311)){
var val_41313 = (a[i_41312]);
if((cljs.core.vector_QMARK_.call(null,val_41313)) && ((reagent.impl.template.key_from_vec.call(null,val_41313) == null))){
(o["no-key"] = true);
} else {
}

(a[i_41312] = reagent.impl.template.as_element.call(null,val_41313));

var G__41314 = (i_41312 + (1));
i_41312 = G__41314;
continue;
} else {
}
...
var ctx = ({});
var vec__41318 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__41318,(0),null);
var derefed = cljs.core.nth.call(null,vec__41318,(1),null);
...
var G__41322 = (cljs.core.count.call(null,argv) - first_child);
switch (G__41322) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__41322){
...
//# sourceMappingURL=template.js.map?rel=1537986101581