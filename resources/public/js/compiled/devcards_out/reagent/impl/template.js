...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27460__auto__,writer__27461__auto__,opt__27462__auto__){
return cljs.core._write.call(null,writer__27461__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__35397 = o;
(G__35397[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__35398__delegate = function (args){
...
while (G__35399__i < G__35399__a.length) {G__35399__a[G__35399__i] = arguments[G__35399__i + 0]; ++G__35399__i;}
  args = new cljs.core.IndexedSeq(G__35399__a,0);
} 
return G__35398__delegate.call(this,args);};
...
return G__35398__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__26796__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26796__auto__){
var and__26796__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__35405 = jsprops;
(G__35405["defaultValue"] = value);

(G__35405["onChange"] = ((function (G__35405,v,value,on_change){
return (function (p1__35403_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__35403_SHARP_);
});})(G__35405,v,value,on_change))
);
...
var vec__35412 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__35412,(0),null);
var id = cljs.core.nth.call(null,vec__35412,(1),null);
var class$ = cljs.core.nth.call(null,vec__35412,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___35417 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___35417 == null)){
} else {
var key_35418 = temp__5461__auto___35417;
(jsprops["key"] = key_35418);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__35420 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__35420["name"] = c);
...
var len__27991__auto___35426 = arguments.length;
var i__27992__auto___35427 = (0);
while(true){
if((i__27992__auto___35427 < len__27991__auto___35426)){
args__27998__auto__.push((arguments[i__27992__auto___35427]));

var G__35428 = (i__27992__auto___35427 + (1));
i__27992__auto___35427 = G__35428;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27999__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35424){
var G__35425 = cljs.core.first.call(null,seq35424);
var seq35424__$1 = cljs.core.next.call(null,seq35424);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__35425,seq35424__$1);
});
...
break;
default:
var G__35432 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__35432;
continue;
...
var n__27821__auto___35435 = a.length;
var i_35436 = (0);
while(true){
if((i_35436 < n__27821__auto___35435)){
(a[i_35436] = reagent.impl.template.as_element.call(null,(a[i_35436])));

var G__35437 = (i_35436 + (1));
i_35436 = G__35437;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__27821__auto___35438 = a.length;
var i_35439 = (0);
while(true){
if((i_35439 < n__27821__auto___35438)){
var val_35440 = (a[i_35439]);
if((cljs.core.vector_QMARK_.call(null,val_35440)) && ((reagent.impl.template.key_from_vec.call(null,val_35440) == null))){
(o["no-key"] = true);
} else {
}

(a[i_35439] = reagent.impl.template.as_element.call(null,val_35440));

var G__35441 = (i_35439 + (1));
i_35439 = G__35441;
continue;
} else {
}
...
var ctx = ({});
var vec__35445 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__35445,(0),null);
var derefed = cljs.core.nth.call(null,vec__35445,(1),null);
...
var G__35449 = (cljs.core.count.call(null,argv) - first_child);
switch (G__35449) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__35449){
...
//# sourceMappingURL=template.js.map?rel=1538029294076