...
var x__27521__auto__ = (((x == null))?null:x);
var m__27522__auto__ = (sablono.util.to_str[goog.typeOf(x__27521__auto__)]);
if(!((m__27522__auto__ == null))){
return m__27522__auto__.call(null,x);
} else {
var m__27522__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__27522__auto____$1 == null))){
return m__27522__auto____$1.call(null,x);
} else {
...
var x__27521__auto__ = (((x == null))?null:x);
var m__27522__auto__ = (sablono.util.to_uri[goog.typeOf(x__27521__auto__)]);
if(!((m__27522__auto__ == null))){
return m__27522__auto__.call(null,x);
} else {
var m__27522__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__27522__auto____$1 == null))){
return m__27522__auto____$1.call(null,x);
} else {
...
var len__27991__auto___35578 = arguments.length;
var i__27992__auto___35579 = (0);
while(true){
if((i__27992__auto___35579 < len__27991__auto___35578)){
args__27998__auto__.push((arguments[i__27992__auto___35579]));

var G__35580 = (i__27992__auto___35579 + (1));
i__27992__auto___35579 = G__35580;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__27999__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq35577){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35577));
});
...
var vec__35584 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__35585 = cljs.core.seq.call(null,vec__35584);
var first__35586 = cljs.core.first.call(null,seq__35585);
var seq__35585__$1 = cljs.core.next.call(null,seq__35585);
var first_word = first__35586;
var words = seq__35585__$1;
...
var G__35588 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__35588,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__35588;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__35589_SHARP_){
if(typeof p1__35589_SHARP_ === 'string'){
return p1__35589_SHARP_;
} else {
return cljs.core.seq.call(null,p1__35589_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__26808__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1538029294463