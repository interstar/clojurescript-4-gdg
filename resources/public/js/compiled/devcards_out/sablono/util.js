...
var x__27522__auto__ = (((x == null))?null:x);
var m__27523__auto__ = (sablono.util.to_str[goog.typeOf(x__27522__auto__)]);
if(!((m__27523__auto__ == null))){
return m__27523__auto__.call(null,x);
} else {
var m__27523__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__27523__auto____$1 == null))){
return m__27523__auto____$1.call(null,x);
} else {
...
var x__27522__auto__ = (((x == null))?null:x);
var m__27523__auto__ = (sablono.util.to_uri[goog.typeOf(x__27522__auto__)]);
if(!((m__27523__auto__ == null))){
return m__27523__auto__.call(null,x);
} else {
var m__27523__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__27523__auto____$1 == null))){
return m__27523__auto____$1.call(null,x);
} else {
...
var len__27992__auto___34914 = arguments.length;
var i__27993__auto___34915 = (0);
while(true){
if((i__27993__auto___34915 < len__27992__auto___34914)){
args__27999__auto__.push((arguments[i__27993__auto___34915]));

var G__34916 = (i__27993__auto___34915 + (1));
i__27993__auto___34915 = G__34916;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__28000__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq34913){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34913));
});
...
var vec__34920 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__34921 = cljs.core.seq.call(null,vec__34920);
var first__34922 = cljs.core.first.call(null,seq__34921);
var seq__34921__$1 = cljs.core.next.call(null,seq__34921);
var first_word = first__34922;
var words = seq__34921__$1;
...
var G__34924 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__34924,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__34924;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__34925_SHARP_){
if(typeof p1__34925_SHARP_ === 'string'){
return p1__34925_SHARP_;
} else {
return cljs.core.seq.call(null,p1__34925_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1537985795536