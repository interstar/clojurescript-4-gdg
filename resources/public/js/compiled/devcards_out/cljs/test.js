...
var args37451 = [];
var len__27991__auto___37455 = arguments.length;
var i__27992__auto___37456 = (0);
while(true){
if((i__27992__auto___37456 < len__27991__auto___37455)){
args37451.push((arguments[i__27992__auto___37456]));

var G__37457 = (i__27992__auto___37456 + (1));
i__27992__auto___37456 = G__37457;
continue;
} else {
}
break;
...
var G__37454 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__37454,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__37454;
}
});
...
var len__27991__auto___37462 = arguments.length;
var i__27992__auto___37463 = (0);
while(true){
if((i__27992__auto___37463 < len__27991__auto___37462)){
args__27998__auto__.push((arguments[i__27992__auto___37463]));

var G__37464 = (i__27992__auto___37463 + (1));
i__27992__auto___37463 = G__37464;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27999__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq37459){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__37460,G__37461,seq37459__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__37468,map__37468__$1,file,line,column){
return (function (p1__37465_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__37465_SHARP_));
});})(map__37468,map__37468__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__27831__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__27831__auto__,prefer_table__27832__auto__,method_cache__27833__auto__,cached_hierarchy__27834__auto__,hierarchy__27835__auto__){
return (function (m){
...
var temp__5457__auto___37470 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___37470)){
var message_37471 = temp__5457__auto___37470;
cljs.core.println.call(null,message_37471);
} else {
}
...
var temp__5457__auto___37472 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___37472)){
var message_37473 = temp__5457__auto___37472;
cljs.core.println.call(null,message_37473);
} else {
}
...
var G__37483 = exception.stack;
var G__37483__$1 = (((G__37483 == null))?null:clojure.string.split_lines.call(null,G__37483));
var G__37483__$2 = (((G__37483__$1 == null))?null:cljs.core.get.call(null,G__37483__$1,depth));
if((G__37483__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__37483__$2);
}
} else {
...
var vec__37484 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__37484,(0),null);
var column = cljs.core.nth.call(null,vec__37484,(1),null);
var vec__37487 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__37487,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__37487,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__37487,(2),null);
...
var m__$1 = (function (){var G__37491 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__37491) {
case "fail":
...
var G__37497 = (function (){var G__37496 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__37496);
} else {
return G__37496;
}
})();
...
return cljs.core.vary_meta.call(null,G__37499,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e37502){var e = e37502;
var G__37503 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__37503) {
...
var vec__37508 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__37508,(0),null);
var types = vec__37508;
...
return cljs.core.map.call(null,(function (p__37520){
var vec__37521 = p__37520;
var ns = cljs.core.nth.call(null,vec__37521,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__37521,(1),null);
return ((function (vec__37521,ns,vars__$1){
return (function (){
...
var G__37524 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__37524) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1){
return (function (){
var seq__37525 = cljs.core.seq.call(null,vars__$1);
var chunk__37526 = null;
var count__37527 = (0);
var i__37528 = (0);
while(true){
if((i__37528 < count__37527)){
var v = cljs.core._nth.call(null,chunk__37526,i__37528);
var temp__5457__auto___37530 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___37530)){
var t_37531 = temp__5457__auto___37530;
each_fixture_fn.call(null,((function (seq__37525,chunk__37526,count__37527,i__37528,t_37531,temp__5457__auto___37530,v,each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_37531)));
});})(seq__37525,chunk__37526,count__37527,i__37528,t_37531,temp__5457__auto___37530,v,each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1))
);
} else {
}

var G__37532 = seq__37525;
var G__37533 = chunk__37526;
var G__37534 = count__37527;
var G__37535 = (i__37528 + (1));
seq__37525 = G__37532;
chunk__37526 = G__37533;
count__37527 = G__37534;
i__37528 = G__37535;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__37525);
if(temp__5457__auto__){
var seq__37525__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__37525__$1)){
var c__27711__auto__ = cljs.core.chunk_first.call(null,seq__37525__$1);
var G__37536 = cljs.core.chunk_rest.call(null,seq__37525__$1);
var G__37537 = c__27711__auto__;
var G__37538 = cljs.core.count.call(null,c__27711__auto__);
var G__37539 = (0);
seq__37525 = G__37536;
chunk__37526 = G__37537;
count__37527 = G__37538;
i__37528 = G__37539;
continue;
} else {
var v = cljs.core.first.call(null,seq__37525__$1);
var temp__5457__auto___37540__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___37540__$1)){
var t_37541 = temp__5457__auto___37540__$1;
each_fixture_fn.call(null,((function (seq__37525,chunk__37526,count__37527,i__37528,t_37541,temp__5457__auto___37540__$1,v,seq__37525__$1,temp__5457__auto__,each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_37541)));
});})(seq__37525,chunk__37526,count__37527,i__37528,t_37541,temp__5457__auto___37540__$1,v,seq__37525__$1,temp__5457__auto__,each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1))
);
} else {
}

var G__37542 = cljs.core.next.call(null,seq__37525__$1);
var G__37543 = null;
var G__37544 = (0);
var G__37545 = (0);
seq__37525 = G__37542;
chunk__37526 = G__37543;
count__37527 = G__37544;
i__37528 = G__37545;
continue;
}
} else {
...
});})(each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1))
);
});})(each_fixture_fn,G__37524,env,once_fixtures,each_fixtures,vec__37521,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1538029296746