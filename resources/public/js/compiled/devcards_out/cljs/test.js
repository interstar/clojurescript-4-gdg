...
var args36505 = [];
var len__27992__auto___36509 = arguments.length;
var i__27993__auto___36510 = (0);
while(true){
if((i__27993__auto___36510 < len__27992__auto___36509)){
args36505.push((arguments[i__27993__auto___36510]));

var G__36511 = (i__27993__auto___36510 + (1));
i__27993__auto___36510 = G__36511;
continue;
} else {
}
break;
...
var G__36508 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__36508,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__36508;
}
});
...
var or__26808__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__27992__auto___36516 = arguments.length;
var i__27993__auto___36517 = (0);
while(true){
if((i__27993__auto___36517 < len__27992__auto___36516)){
args__27999__auto__.push((arguments[i__27993__auto___36517]));

var G__36518 = (i__27993__auto___36517 + (1));
i__27993__auto___36517 = G__36518;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28000__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq36513){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__36514,G__36515,seq36513__$2);
});
...
var line = cljs.core.get.call(null,map__36522__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__36522__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__36522,map__36522__$1,file,line,column){
return (function (p1__36519_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__36519_SHARP_));
});})(map__36522,map__36522__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__27832__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__27832__auto__,prefer_table__27833__auto__,method_cache__27834__auto__,cached_hierarchy__27835__auto__,hierarchy__27836__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__26808__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__26808__auto__)){
return or__26808__auto__;
} else {
...
var temp__5457__auto___36524 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___36524)){
var message_36525 = temp__5457__auto___36524;
cljs.core.println.call(null,message_36525);
} else {
}
...
var temp__5457__auto___36526 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___36526)){
var message_36527 = temp__5457__auto___36526;
cljs.core.println.call(null,message_36527);
} else {
}
...
var temp__5455__auto__ = (function (){var and__26796__auto__ = typeof exception.stack === 'string';
if(and__26796__auto__){
var G__36537 = exception.stack;
var G__36537__$1 = (((G__36537 == null))?null:clojure.string.split_lines.call(null,G__36537));
var G__36537__$2 = (((G__36537__$1 == null))?null:cljs.core.get.call(null,G__36537__$1,depth));
if((G__36537__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__36537__$2);
}
} else {
...
var vec__36538 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__36538,(0),null);
var column = cljs.core.nth.call(null,vec__36538,(1),null);
var vec__36541 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__36541,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__36541,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__36541,(2),null);
...
var m__$1 = (function (){var G__36545 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__36545) {
case "fail":
...
var G__36551 = (function (){var G__36550 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__36550);
} else {
return G__36550;
}
})();
...
return cljs.core.vary_meta.call(null,G__36553,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__36557 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__36557) {
...
var vec__36562 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__36562,(0),null);
var types = vec__36562;
...
return cljs.core.map.call(null,(function (p__36574){
var vec__36575 = p__36574;
var ns = cljs.core.nth.call(null,vec__36575,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__36575,(1),null);
return ((function (vec__36575,ns,vars__$1){
return (function (){
...
var G__36578 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__36578) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1){
return (function (){
var seq__36579 = cljs.core.seq.call(null,vars__$1);
var chunk__36580 = null;
var count__36581 = (0);
var i__36582 = (0);
while(true){
if((i__36582 < count__36581)){
var v = cljs.core._nth.call(null,chunk__36580,i__36582);
var temp__5457__auto___36584 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___36584)){
var t_36585 = temp__5457__auto___36584;
each_fixture_fn.call(null,((function (seq__36579,chunk__36580,count__36581,i__36582,t_36585,temp__5457__auto___36584,v,each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_36585)));
});})(seq__36579,chunk__36580,count__36581,i__36582,t_36585,temp__5457__auto___36584,v,each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1))
);
} else {
}

var G__36586 = seq__36579;
var G__36587 = chunk__36580;
var G__36588 = count__36581;
var G__36589 = (i__36582 + (1));
seq__36579 = G__36586;
chunk__36580 = G__36587;
count__36581 = G__36588;
i__36582 = G__36589;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__36579);
if(temp__5457__auto__){
var seq__36579__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__36579__$1)){
var c__27712__auto__ = cljs.core.chunk_first.call(null,seq__36579__$1);
var G__36590 = cljs.core.chunk_rest.call(null,seq__36579__$1);
var G__36591 = c__27712__auto__;
var G__36592 = cljs.core.count.call(null,c__27712__auto__);
var G__36593 = (0);
seq__36579 = G__36590;
chunk__36580 = G__36591;
count__36581 = G__36592;
i__36582 = G__36593;
continue;
} else {
var v = cljs.core.first.call(null,seq__36579__$1);
var temp__5457__auto___36594__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___36594__$1)){
var t_36595 = temp__5457__auto___36594__$1;
each_fixture_fn.call(null,((function (seq__36579,chunk__36580,count__36581,i__36582,t_36595,temp__5457__auto___36594__$1,v,seq__36579__$1,temp__5457__auto__,each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_36595)));
});})(seq__36579,chunk__36580,count__36581,i__36582,t_36595,temp__5457__auto___36594__$1,v,seq__36579__$1,temp__5457__auto__,each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1))
);
} else {
}

var G__36596 = cljs.core.next.call(null,seq__36579__$1);
var G__36597 = null;
var G__36598 = (0);
var G__36599 = (0);
seq__36579 = G__36596;
chunk__36580 = G__36597;
count__36581 = G__36598;
i__36582 = G__36599;
continue;
}
} else {
...
});})(each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1))
);
});})(each_fixture_fn,G__36578,env,once_fixtures,each_fixtures,vec__36575,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1537985797144